...
Now, we have a controlmap.txt within a mod that needs to be loaded by Skyrim. For us to ensure that happens, open up MO2 and ensure that the mod "Gamepad Specific - Modified controlmap.txt" is enabled (Click the box to it's left). It should be under the "Generated Files" heading and down at the bottom of the mods within that heading. If you can't find it, in the lower right corner of the main mod pane, you should see a search box. Type in the name of the mod in this searchbox and it should narrow it down for you.
